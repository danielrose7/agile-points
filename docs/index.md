...
- **Speaks your language.** The app UI ships in English, Español, Deutsch,
  Français, Português, and 日本語 — auto-detected from your browser, with a
  🌐 switcher in the footer. Language is personal, not per-room: one invite
  link, and each teammate sees their own. (These docs stay English.)
